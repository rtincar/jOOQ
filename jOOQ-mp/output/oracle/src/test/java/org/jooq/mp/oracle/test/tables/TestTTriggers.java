...
import static org.jooq.mp.oracle.test.tables.TTriggers.__T_TRIGGERS;
...
public class TestTTriggers {

	@Test
	public void testTTriggers () {
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @jooq-unittest-testTTriggers-test@
			...
			for (Record r : result) {
                 java.lang.Long idGenerated = r.getValue(__T_TRIGGERS.ID_GENERATED);
				System.out.println(
