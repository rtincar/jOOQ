...
import org.jooq.mp.oracle.test.tables.records.TDatesRecord;
...
public class TDates extends org.jooq.impl.UpdatableTableImpl <TDatesRecord> {
	 ...
	 * D mapping for D
	 */
	public final TableField<TDatesRecord, java.sql.Timestamp> D = createField("D", org.jooq.impl.SQLDataType.TIMESTAMP, this);
 	/**
	 * T mapping for T
	 */
	public final TableField<TDatesRecord, java.sql.Timestamp> T = createField("T", org.jooq.impl.SQLDataType.TIMESTAMP, this);
 	/**
	 * TS mapping for TS
	 */
	 ...
	 */
	public final TableField<TDatesRecord, java.lang.Long> D_INT = createField("D_INT", org.jooq.impl.SQLDataType.BIGINT, this);
 	/**
