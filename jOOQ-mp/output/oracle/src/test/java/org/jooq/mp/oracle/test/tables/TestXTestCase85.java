...
import static org.jooq.mp.oracle.test.tables.XTestCase85.__X_TEST_CASE_85;
...
public class TestXTestCase85 {

	@Test
	public void testXTestCase85 () {
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @jooq-unittest-testXTestCase85-test@
			...
			for (Record r : result) {
                 java.lang.Long id = r.getValue(__X_TEST_CASE_85.ID);
                   java.lang.Long XUnusedId = r.getValue(__X_TEST_CASE_85.X_UNUSED_ID);
				System.out.println(
                     "id : "+ id +
                       "XUnusedId : "+ XUnusedId +
                    ""
