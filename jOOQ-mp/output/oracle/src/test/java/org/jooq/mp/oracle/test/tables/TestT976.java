...
import static org.jooq.mp.oracle.test.tables.T976.__T_976;
...
public class TestT976 {

	@Test
	public void testT976 () {
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @jooq-unittest-testT976-test@
			// write your own tests, just set DISABLE to ENABLE in the comment above
			// future generation will not erase your code ;)
			Result<Record> result = create.select().from(__T_976).limit(1).fetch();
			for (Record r : result) {
                 java.lang.Long id = r.getValue(__T_976.ID);
				System.out.println(
                     "id : "+ id +
                    ""
					);
