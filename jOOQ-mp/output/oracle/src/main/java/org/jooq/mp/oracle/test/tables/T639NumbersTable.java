...
public class T639NumbersTable extends org.jooq.impl.UpdatableTableImpl <T639NumbersTableRecord> {
	 ...
	 * PRIMARY KEY ID
	 */
	public final TableField<T639NumbersTableRecord, java.lang.Long> ID = createField("ID", org.jooq.impl.SQLDataType.BIGINT, this);

 	/**
	 * BYTE mapping for BYTE
	 */
	public final TableField<T639NumbersTableRecord, java.lang.Long> BYTE = createField("BYTE", org.jooq.impl.SQLDataType.BIGINT, this);
 	/**
	 * SHORT mapping for SHORT
	 */
	public final TableField<T639NumbersTableRecord, java.lang.Long> SHORT = createField("SHORT", org.jooq.impl.SQLDataType.BIGINT, this);
 	/**
	 * INTEGER mapping for INTEGER
	 */
	public final TableField<T639NumbersTableRecord, java.lang.Long> INTEGER = createField("INTEGER", org.jooq.impl.SQLDataType.BIGINT, this);
 	/**
	 ...
	 */
	public final TableField<T639NumbersTableRecord, java.lang.Integer> BIG_INTEGER = createField("BIG_INTEGER", org.jooq.impl.SQLDataType.INTEGER, this);
 	/**
