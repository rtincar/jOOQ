...
import org.jooq.mp.hsqldb.test.tables.records.XTestCase85Record;
...
public class XTestCase85 extends org.jooq.impl.UpdatableTableImpl <XTestCase85Record> {
	 ...
	 * PRIMARY KEY ID
	 */
	public final TableField<XTestCase85Record, java.lang.Integer> ID = createField("ID", org.jooq.impl.SQLDataType.INTEGER, this);
	 ...
	 * </pre></code>
	 */
	public final TableField<XTestCase85Record, java.lang.Integer> X_UNUSED_ID = createField("X_UNUSED_ID", org.jooq.impl.SQLDataType.INTEGER, this);
