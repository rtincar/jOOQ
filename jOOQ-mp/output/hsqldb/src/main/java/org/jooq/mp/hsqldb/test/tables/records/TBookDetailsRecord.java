...
import org.jooq.mp.hsqldb.test.tables.TBookDetails;
...
public class TBookDetailsRecord extends UpdatableRecordImpl<org.jooq.mp.hsqldb.test.tables.records.TBookDetailsRecord> {
 ...
 //MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @jooq-record-pk-test@
    ...
    public void setId(java.lang.Integer value) {
        setValue(org.jooq.mp.hsqldb.test.tables.TBookDetails.__T_BOOK_DETAILS.ID, value);
    }
	/**
	 * An uncommented item
	 * 
    ...
    public java.lang.Integer getId() {
        return getValue(org.jooq.mp.hsqldb.test.tables.TBookDetails.__T_BOOK_DETAILS.ID);
    }
  ...
  //MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @jooq-record-child-TBooks-test@
	...
	public java.util.List<org.jooq.mp.hsqldb.test.tables.records.TBookRecord> fetchTBooksList() {
		return create()
			...
			.where(org.jooq.mp.hsqldb.test.tables.TBook.__T_BOOK.DETAILS_ID.equal(getValue(org.jooq.mp.hsqldb.test.tables.TBookDetails.__T_BOOK_DETAILS.ID))) 
			.fetch();
	}
...
//many2many
	...
	public TBookDetailsRecord() {
		super(org.jooq.mp.hsqldb.test.tables.TBookDetails.__T_BOOK_DETAILS);
	}
