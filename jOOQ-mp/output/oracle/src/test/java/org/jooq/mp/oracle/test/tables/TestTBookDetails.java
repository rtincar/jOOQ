...
import static org.jooq.mp.oracle.test.tables.TBookDetails.__T_BOOK_DETAILS;
...
public class TestTBookDetails {

	@Test
	public void testTBookDetails () {
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @jooq-unittest-testTBookDetails-test@
			...
			for (Record r : result) {
                 java.lang.Long id = r.getValue(__T_BOOK_DETAILS.ID);
				System.out.println(
                     "id : "+ id +
                    ""
					);
