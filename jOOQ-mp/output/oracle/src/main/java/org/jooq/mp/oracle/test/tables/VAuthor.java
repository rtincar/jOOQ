...
import org.jooq.mp.oracle.test.tables.records.VAuthorRecord;
...
public class VAuthor extends org.jooq.impl.UpdatableTableImpl <VAuthorRecord> {
	 ...
	 * ID mapping for ID
	 */
	public final TableField<VAuthorRecord, java.lang.Long> ID = createField("ID", org.jooq.impl.SQLDataType.BIGINT, this);
 	/**
	 ...
	 */
	public final TableField<VAuthorRecord, java.sql.Timestamp> DATE_OF_BIRTH = createField("DATE_OF_BIRTH", org.jooq.impl.SQLDataType.TIMESTAMP, this);
 	/**
	 * YEAR_OF_BIRTH mapping for YEAR_OF_BIRTH
	 */
	public final TableField<VAuthorRecord, java.lang.Long> YEAR_OF_BIRTH = createField("YEAR_OF_BIRTH", org.jooq.impl.SQLDataType.BIGINT, this);
 	/**
	 * ADDRESS mapping for ADDRESS
	 */
	public final TableField<VAuthorRecord, java.lang.String> ADDRESS = createField("ADDRESS", org.jooq.impl.SQLDataType.OTHER, this);
